<x-app-layout>
    ...
    @if(Session::has('success'))
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('users.create') }}" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Add User</a>
        </div>
                    ...
                    @foreach($users as $user)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                ...
                                <button onclick="openModal('{{ route('users.delete', $user->id) }}')">Delete</button>
